package alsu_driver_pkg;
  ...
  class alsu_driver extends uvm_driver;
    ...
    function void build_phase(uvm_phase phase);
      ...
      alsu_config_obj_driver = alsu_config_obj::type_id::create("alsu_config_obj_driver");
      uvm_config_db #(alsu_config_obj)::get(this,"","CFG", alsu_config_obj_driver);
    endfunction
    ...
    task run_phase(uvm_phase phase);
        ...
        alsu_driver_vif.A = 0;
        alsu_driver_vif.B = 0;
        @(negedge alsu_driver_vif.clk) alsu_driver_vif.rst = 1;
        @(negedge alsu_driver_vif.clk) alsu_driver_vif.rst = 0;
        forever begin
